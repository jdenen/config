...
** elixir
   ...
   I'm experimenting with =eglot= and =elixir_ls=.
   #+NAME: elixir-ls
   #+BEGIN_SRC emacs-lisp
     (use-package eglot :ensure t)
     (add-to-list 'eglot-server-programs '(elixir-mode . ("/Users/johnson/.elixir/release/language_server.sh")))
