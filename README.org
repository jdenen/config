...
* .bash_profile
  ...
  #+END_SRC
* .bashrc
  #+BEGIN_SRC sh :tangle ~/bin/elixirls :shebang "#!/usr/bin/env bash"
    sh ~/Code/me/dot/elixir-ls/release/language_server.sh
  #+END_SRC
...
** elixir
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package lsp-mode
       ...
       (elixir-mode . lsp)
       :init
       (add-to-list 'exec-path "~/Code/me/dot/elixir-ls/release/"))
