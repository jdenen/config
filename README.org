     ...
     #+BEGIN_SRC emacs-lisp
              (setq org-log-done   'time
                    ...
                    '((sequence "BKLG(b)" "TODO(t)" "WIP(w)" "|" "DONE(d)" "CNCL(c)")
                      (sequence "CRAFT(a)" "RETRO(r)" "LEADS(l)" "READ(e)" "|"))
...
***** Templates
       ...
       #+BEGIN_SRC text :tangle ~/.emacs.d/read.orgcaptmpl
         ,* READ %^{Title} (%^{Author}) :read:%^{Type|book|blog}:%^g
         ,** %?
       #+END_SRC
**** RSS
