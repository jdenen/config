...
** Bash
   #+BEGIN_SRC sh :tangle ~/.bash_profile
     ...
     function asdf-latest {
         ...
         version=$(asdf list-all $package | tail -1)
     ...
     export PATH=$PATH:~/.asdf/installs/python/stackless-3.5.4/bin
   #+END_SRC
** Emacs
*** Chrome
    #+NAME: chrome
